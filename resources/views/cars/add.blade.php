                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="col-md-6">
                                <form role="form" method="post" class="form-horizontal" action="{{ route('cars.save') }}" novalidate="novalidate">
                                @csrf
                                <div class="panel-body"> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" value="{{ old('owner_name') }}" name="owner_name" class="form-control">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" value="{{ old('vehicle_number') }}" name="vehicle_number" class="form-control">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="number" value="{{ old('price') }}" min="0" name="price" class="form-control">
                                            @if($errors->has('price'))
                                    ...
                                    <div class="form-group"> 
                                        ...
                                        <label class="col-md-3 control-label"></label>                                
                                            <button class="btn btn-primary pull-center">Save</button></form>
